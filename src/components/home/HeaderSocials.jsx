...
const HeaderSocials = () => {
    return (
        <div className='home__socials'>
            <a href='https://github.com/Hiteshshingala' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaGithub />
            </a>
            ...
            <a href='https://www.linkedin.com/in/hiteshshingala' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaLinkedinIn />
            </a>
            ...
            <a href='https://twitter.com/Hitesh1583' className='home__social-link' target='__blank' rel='noreferrer'>
                <FaTwitter />
            </a>
        </div>
    );
